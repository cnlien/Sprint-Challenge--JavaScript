...
console.log(" ")
console.log("==== Objects ====")
console.log("Using your dinosaur objects, log answers to these questions:")
...
console.log(" ")
console.log('=== ARRAYS ===')
console.log('Given an array of college graduates.  Complete the following requests using any array method you like')
const graduates = [
...
console.log(" ")
console.log('Request 1: Create a new array called universities that contains all the universities in the graduates array.')
...
zooAnimals.map(zooAnimals => {
  lowerCase.push(`Lower Case Name: ${zooAnimals.animal_name.toLowerCase()}`)
});
...
populationTotal = zooAnimals.reduce ((totalAnimals, zooAnimals) => {
  return totalAnimals + zooAnimals.population;
}, 0);

console.log(" ")
console.log("Request 4: .reduce()")
console.log(`Total Animals: ${populationTotal}`);
